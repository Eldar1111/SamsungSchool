...
import com.example.adaptertest.adapter.PersonAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public String Forbes_list [] = {"Bill Gates",
            "Warren Buffett",
            "Jeff Bezos",
            "Amancio Ortega",
            "Mark Zuckerberg",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        System.out.println(Forbes_flags.length);
        recyclerView = findViewById(R.id.rv_people);
        recyclerView.setAdapter(new PersonAdapter(people, LayoutInflater.from(this)));
    }
    ...
    public void init (){
        ...
        Person person;
        for (int i = 0; i < 100; i++) {
            person = new Person(Forbes_list[i], Forbes_money[i], Forbes_flags[i]);
            people.add(person);
        }
    }
}